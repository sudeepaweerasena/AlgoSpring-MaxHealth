...
class NewCase:
    ...
    async def extract_and_save_benefits(self):
        try:
            ...
            if benefits:
                ...
                # await self.page.wait_for_selector('button[aria-label="close"]', state='visible', timeout=10000)
    ...
    async def create_new_case(self):
        ...
        print(self.df2.columns)  # Print the column names
        print(self.df2.head())   
        
        print(self.df1.columns)  # Print the column names
        print(self.df1.head())   # Print the first few rows of the DataFrame# Print the first few rows of the DataFrame
        ...
        for category in categories_present:
            ...
            # Locate the dropdown and select the plan for the category
            # Locate the dropdown and select the plan for the category
            if category == 'A':
                await self.page.locator('//*[@id="root"]/div/main/div/div/div[2]/div[1]/div/div[1]/div[2]/div[2]/div/div').click()
                await asyncio.sleep(0.5)  # Slight delay before clicking the plan
                ...
                print("click2")
                await asyncio.sleep(5)  # Slight delay after clicking the plan               
            if category == 'B':
            ...
            await asyncio.sleep(0.5)  # Additional delay after clicking "View Benefit" button
        ...
        element = self.page.locator('//*[@id="root"]/div/main/div/div/div[1]/div[1]/div[1]/div/div/span[1]')  # Corrected to remove await
        extracted_value = await element.text_content()  # Correct use of await
        ...
        # # Take a screenshot
        # screenshot_path = "D:\\AlgoSpring\\python\\MaxHealth\\screenshot.png"  # Specify a file name with an extension
